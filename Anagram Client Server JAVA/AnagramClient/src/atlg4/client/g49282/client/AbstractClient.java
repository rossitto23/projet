package atlg4.client.g49282.client;
...
/**
 * Cette classe contient ce qu'il faut pour développer un CLIENT!
 *
 * Cette classe sert à gérer la communication avec un serveur. Elle présente les
...
public abstract class AbstractClient extends Observable implements Runnable {
     ...
     *
     * flux de sortie des données a envoyer vers le serveur
     */
     ...
     *
     * flux d'entrée des données venant du serveur
     */
     ...
     *
     * Thread ecoutant les messages du serveur
     */
     ...
     *
     * signale si une demande d'arrêt du client a été demandée
     */
     ...
     *
     * adresse du serveur localhost,192.***.***
     */
    private String host;
     ...
     *
     * permet de fermer les flux utilisés pour communiquer avec le serveur
     *
    ...
    /**
     * verifie si le client est connecté au serveur
     *
