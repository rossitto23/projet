...
import atlg4.ultimate.g49282.model.MiniTicTacToe;
import atlg4.ultimate.g49282.model.Symbol;
import atlg4.ultimate.g49282.model.UltimateTicTacToe;
...
public class MyUTTController {
    ...
    public MyUTTController(Game game) {
        this.game = game;
    ...
    public void initialize() {
        ...
        surrend.setOnAction((ActionEvent event) -> {
            try {
                ...
                Logger.getLogger(MyUTTController.class.getName()).log(Level.SEVERE, null, ex);
            }
     ...
     *
     * @param s the value of player symbol.
     * @param i the index of the list for mini ttt.
     */
    public void setWinner(String s, int i) {
        if (s != "" && s != null) {
            list.get(i).setWinner(s);
        }
    ...
    private void printEnd() throws IOException {
        FXMLLoader l = new FXMLLoader(getClass().getResource("view/EndGame.fxml"));
